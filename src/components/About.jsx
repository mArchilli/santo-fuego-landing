        ...
        <div className="relative">
          ...
          <ul className="grid sm:grid-cols-2 gap-5 mb-10">
            {[
              ...
              <li key={f.title} className="p-4 rounded-xl bg-white/5 border border-white/10 hover:border-red-400/50 transition">
                <p className="font-semibold text-red-400 mb-1">{f.title}</p>
